                ...
                <div class="col-lg-4 d-block mx-auto">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-md-12">
                            <div class="card">
                                <form method="POST" action="{{url("admin/create/admin")}}">
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <h3> ورود </h3>
                                        <p class="text-muted">ثبت مدیر جدید</p>
                                        ...
                                        <div class="input-group mb-3">
                                            <span class="input-group-addon "><i class="fa fa-user"></i></span>
                                            <input type="text" class="form-control" name="phone" placeholder="شماره همراه">
                                        </div>
                                        ...
                                        <div class="mt-6 btn-list">
                                            <a href="{{url("admin")}}" class="btn btn-icon btn-google"><i class="fa fa-backward"></i></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
