...
<head>
    ...
    <title>پنل مدیریتی نماینده</title>
...
<footer class="footer footer-static footer-light navbar-border navbar-shadow">
    تمامی حقوق مادی و معنوی این سایت متعلق به هلدینگ هرس میباشد و هرگونه کپی برداری پیگرد قانونی دربر خواهد داشت . طراحی شده توسط شرکت آریا گستران
</footer>
<!-- END: Footer-->
