                    ...
                    <div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="{{url("organ/send/verify")}}" method="post" >
                                        @csrf
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" maxlength="11" pattern="[0]{1}[9]{1}[0-9]{9}"  oninvalid="this.setCustomValidity('لطفا شماره درست وارد کنید')" oninput="setCustomValidity('')" class="form-control round" name="phone" id="user-name" placeholder="شماره همراه" required>
