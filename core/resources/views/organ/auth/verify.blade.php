...
<head>
    ...
    <title>احراز هویت نماینده</title>
                    ...
                    <div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="{{url("organ/verify")}}" method="post" novalidate>
                                        @csrf
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" disabled class="form-control round" name="phone" style="font-size: 24px ; text-align: center" id="user-name" value="{{$phone}}"  required>
                                            <input type="hidden"  class="form-control round" name="phone" id="user-name" value="{{$phone}}"  required>
                                            <div class="form-control-position">
                                                <i class="ft-phone"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" name="verify" id="user-name" value="{{$verify}}" placeholder="کد اعتبارسنجی" required>
                                            <div class="form-control-position">
                                                <i class="ft-user"></i>
                                            </div>
                                        </fieldset>
                                        ...
                                        <div class="form-group text-center">
                                            <button type="submit" class="btn round btn-block btn-glow btn-bg-gradient-x-purple-blue col-12 mr-1 mb-1">اعتبارسنجی</button>
                                        </div>
