                                                    ...
                                                    <table class="table table-striped table-bordered zero-configuration">
                                                        ...
                                                        @foreach($users as $user)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$user->cart}}</td>
                                                                <td>
                                                                    <a href="{{url("/organ/user/basket")}}/{{$user->id}}" class="btn btn-primary btn-sm buttonAnimation" data-animation="rubberBand"> سبد خرید</a>
                                                                </td>
                                                                <td>
                                                                    <a href="{{url("organ/user/cart")}}/{{$user->id}}" class="btn btn-primary btn-sm buttonAnimation" data-animation="rubberBand"> کارت ها</a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
