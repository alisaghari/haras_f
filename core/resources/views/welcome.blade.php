...
<head>
    ...
    <!-- Owl Carousel CSS -->
    <link rel="stylesheet" href="{{url("websiteui")}}/vendor/OwlCarousel/owl.carousel.min.css">
    <link rel="stylesheet" href="{{url("websiteui")}}/vendor/OwlCarousel/owl.theme.default.min.css">
    <!-- Magnific Popup CSS -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="view-all-btn" style="padding: 35px;">
                        <div class="view-all-btn text-center">
                            <a href="{{url("websiteui")}}/http://www.harascard.ir/doctors" class="item-title btn-fill gradient-aqua">ثبت نام پزشک</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="view-all-btn" style="padding: 35px;">
                        <div class="view-all-btn text-center">
                            <a href="{{url("websiteui")}}/http://www.harascard.ir/user" class="item-title btn-fill gradient-aqua">ثبت نام عمومی</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="view-all-btn" style="padding: 35px;">
                        <div class="view-all-btn text-center">
                            <a href="{{url("websiteui")}}/#" class="item-title btn-fill gradient-aqua">رزرو پزشک</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="pricing-box-layout3">
                    <h3 class="item-title"> بیمه پوست و مو </h3>
                    <hr>
                    <p>
                        بیمه ها تنها درمان هایی از پوست و مو را پوشش خواهند داد که جنبه ی ترمیمی دارند ، یعنی انجام چنین
                        ...
                        بیمه درمانی نیز در مقایسه با این هزینه ها ، هزینه بسیار کمتری را دریافت می کند ، پوشش عمل های
            ...
            <div class="col-lg-4">
                <div class="pricing-box-layout3">
                    <h3 class="item-title">بیمه دندانپزشکی</h3>
                    <hr>
                    <p>
                        با توجه به تقاضای بالایی که برای تهیه بیمه نامه های دندانپزشکی وجود دارد، متاسفانه سود جویی‌های
                        بسیاری بابت این موضوع انجام گرفته که افراد سود جو با فروش کارت بیمه دندانپزشکی بدون پشتوانه
                        معتبر اقدام به دریافت حق بیمه از بیمه گذاران نموده اند و این موضوع مشکلات بسیاری را برای بیشتر
                        افراد ایجاد کرده.از این رو ارائه طرح های مختلف دندانپزشکی از سوی شرکت های بیمه مختلف به همراه بیمه درمان
            ...
            <div class="col-lg-4">
                <div class="pricing-box-layout3">
                    <h3 class="item-title">بیمه چشم پزشکی</h3>
                    <hr>
                    <p>
                        در بیمه تکمیلی اگر متقاضی، قبل از خرید بیمه بیماری خاصی داشته باشد، نمی‌تواند از پوشش بیمه‌ای
                        استفاده کند. به همین دلیل در بیمه تکمیلی چشم ، برای پوشش رفع عیوب انکساری لازم است شماره چشم
                        متقاضی بیمه صفر بوده و ضعیف نباشد. بیمه سامان برای بیمه کردن افرادی که چشمان ضعیفی دارند
                        انعطاف بیشتری به خرج می‌دهد. به این ترتیب اگر فرد درصد کمی ضعف چشم داشته باشد درصورت
                        تایید پزشک معتمد بیمه، می‌تواند از پوشش رفع عیوب انکساری بهره‌مند شود.
                    </p>
                    <hr>
                    <a href="{{url("websiteui")}}/#" class="ghost-btn-2 border-aqua text-white">سفارش<i class="fas fa-arrow-circle-right"></i></a>
                </div>
